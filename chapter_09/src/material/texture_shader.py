...
class TextureShader:
    ...
    def __init__(
        ...
        try:
            ...
            self.logger = LlamediaLogger("TextureShader").getLogger()
            ...
            self.material = self.editor_node.material
            ...
            print("[ERROR] Could not initialize TextureShader object.")
    ...
    def set_object(self, mesh_object=None):
        ...
        if not mesh_object or not hasattr(mesh_object, 'type') or mesh_object.type != 'MESH':
            warn_msg = f"A valid mesh object must be provided."
