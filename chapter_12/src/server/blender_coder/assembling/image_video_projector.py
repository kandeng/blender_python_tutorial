...
class ImageVideoProjector:
    ...
    def usage_demo():
        ...
        print("\n\n" + "=" * 120 + "\n")
        print(f"\t Must display in the 'rendered preview mode' with 'cycles' rendering engineer.")
        print(f"\t If displayed in the 'material preview mode', the frames on different screens will be mixed together. ")
        print("\n" + "=" * 120 + "\n\n")
