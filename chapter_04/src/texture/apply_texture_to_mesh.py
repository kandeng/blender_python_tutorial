...
class ApplyTexture:
    ...
    """
    def __init__(self, mesh_object=None, texture_dir="/", use_modifier=True):
        """
        ...
        if mesh_object is None:
            ...
            self.set_mesh_object(mesh_object)

        if texture_dir == "/" or texture_dir == ""  or texture_dir is None:
    ...
    def set_mesh_object(self, mesh_object=None):
    ...
    def _scan_texture_directory(self):
        ...
        print(f"\n[INFO] texture_files in file diretory '{self.texture_dir}':")
    ...
    def create_displacement_modifier(self, disp_strength:float=0.5, midlevel:float=0.5):
